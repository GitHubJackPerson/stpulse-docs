<div class="stp-hero">
  ...
  <div class="stp-hero-text">
    <h1>База знаний STPulse</h1>
    <p>Инструкции, подсказки и практические сценарии для работы с сервисом STPulse.</p>
...
<div class="stp-card-grid">
  ...
  <a class="stp-card" href="faq/overview/">
    ...
    <p>Ответы на частые вопросы и контакты службы поддержки.</p>
  </a>
...
<div class="stp-image-group">

  <div class="stp-pill stp-pill-finances">
    <div class="stp-pill-icon">💰</div>
    <div class="stp-pill-title">Финансы</div>
    <p>Прибыли и убытки, планирование и ДДС в одном месте.</p>
  </div>

  <div class="stp-pill stp-pill-analytics">
    <div class="stp-pill-icon">📈</div>
    <div class="stp-pill-title">Аналитика</div>
    <p>Операционка, юнит-экономика и возвраты по каждому товару.</p>
  </div>
...
1. Используйте **поиск** в правом верхнем углу, если знаете, что ищете.
2. За ориентир возьмите карточки разделов на этой странице.
3. Если не получается решить задачу по инструкции — напишите в поддержку:
