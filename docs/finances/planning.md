...
Зависит от показателя. Выручка и прибыль — в рублях. Продажи (шт) и возвраты (шт) — в штуках. Расчётус автоматически использует правильную единицу для каждой метрики.
